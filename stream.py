...
if df_with_cities_coo['city']=='Севастополь' or df_with_cities_coo['city']=='Москва' or df_with_cities_coo['city']=='Санкт-Петербург':
...
model = LightGBM()
prediction = model.predict_price(df_with_cities_coo)
